...
export interface ApiDatenschutzDatenschutz extends Schema.SingleType {
...
export interface ApiDiscountCodeDiscountCode extends Schema.CollectionType {
  ...
  attributes: {
    ...
    descuento: Attribute.Decimal & Attribute.Required;
    usos: Attribute.Integer;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiProductProduct extends Schema.CollectionType {
  ...
  attributes: {
    ...
    variante: Attribute.Component<'variant.variant', true> &
      Attribute.Required &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
